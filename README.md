...
* **Frontend:** Vanilla JavaScript, Web Audio API, HTML5, CSS3, LocalStorage.
* **Infrastructure:** Docker, Docker Compose, Nginx, GitHub Actions (CI/CD).
* **AI Models:** Google Gemini Multimodal Live API (Audio) & Gemini 2.5 Flash API (Text Scorecards).
...
## 🎮 How to Use (Demo Flow)
 1. Select Persona: Choose your preferred AI interviewer from the dropdown.
 2. Start Call: Click Start Call and grant microphone permissions. The AI will introduce itself naturally.
 3. Discuss & Review: Talk about your tech stack. Paste a GitHub file or full Repo URL and click Fetch GitHub. The AI will read the context instantly and discuss it with you.
 4. Control the Flow: Use the Pause Mic or Mute AI buttons if you need a break.
 5. Get Evaluated: Click End Call to receive your detailed architectural Scorecard.
 6. Track Progress: Click the 📜 History button to review your past interview scorecards.
