...
## 🔥 Killer Features
* **🏢 Custom Mock Interviews (Targeted JD):** Paste a specific Job Description (JD), and the AI will act as the Hiring Manager—screening your experience, asking tailored questions, and gracefully concluding the call if your profile doesn't match.
...
* **🛡️ Secure Live Code Sandbox:** Execute your Go code live during the interview! The Go backend spins up an isolated, network-disabled ephemeral Docker container, runs the code, and feeds the *actual* terminal output back to the AI. This eliminates AI hallucinations with 100% accuracy.
...
![TechPrep Architecture](assets/TechPrep Diagram.jpg)
 ...
 * 🌍 Polyglot Execution Sandbox: Currently, the secure Docker sandbox supports Golang execution. The roadmap includes expanding this to support Python, JavaScript/Node.js, Java, and C++ dynamically based on file extensions.
